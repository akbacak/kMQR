...
load('/home/ubuntu/keras/enver/dmlvh2/DMQVR/myDataset/hashCodes/hashCodes_32.mat');
data = hashCodes_32;
...
queryIndex = xlsread('/home/ubuntu/keras/enver/dmlvh2/DMQVR/qLabels_2.xls'); 
...
queryIndex2 = queryIndex(2,:);        % Second element of Query Triplets
 ...
 for l = 1:200 % Number of Query Pairs , CAN TRY FOR DIFFERENT HAMMING RADIUS ALSO ?????? how?
