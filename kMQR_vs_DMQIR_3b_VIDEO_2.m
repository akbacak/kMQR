...
load('/home/ubuntu/keras/enver/dmlvh2/DMQVR/myDataset2/hashCodes/hashCodes_128.mat');
data = hashCodes_128;
...
queryIndex = xlsread('/home/ubuntu/keras/enver/dmlvh2/DMQVR/qLabels_2_3d.xls'); 
 ...
 for l = 1:150 % Number of Query Pairs , CAN TRY FOR DIFFERENT HAMMING RADIUS ALSO ?????? how?
   ...
   %%%%%%%%%%%%%%%%%%%% Precision & Recall for DMQIR  %%%%%%%%%%%%%%%%%%%%
    ...
    for j= 1:maxFront
        ...
        union_of_query_labels_DMQIR{l,:} = or(union_of_query_labels_DMQIR{l,:}, targets(queryIndex(2,l), : ));
